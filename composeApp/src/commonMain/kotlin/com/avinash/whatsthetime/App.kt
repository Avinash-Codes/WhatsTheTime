...
import com.avinash.whatsthetime.userInterface.CityClockApp
...
//        LaunchedEffect(Unit) {
//            while (true) {
//                currentTime.value = currentDateAndTime("Japan")
//                delay(1000)
//            }
//        }
//
...
//        CityClockApp()
        ...
        MainLayout(navController = navController) {
            NavHost(navController = navController, startDestination = Screen.HomeScreen.route) {
                ...
                composable(Screen.ListScreen.route) { CityClockApp(navController) }
